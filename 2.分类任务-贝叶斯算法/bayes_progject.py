...
class BayesApproach:
    def __init__(self,data_path):
        self.p_class = defaultdict(int) #样本概率
            ...
            for line in f:
                ...
                for word in words:
                    if word not in word_freq:
                        ...
                        word_freq[word] += 1
        #print(self.class_name_to_word_freq) #'社会'：{'中国': 1, ...... '美无法防御很急躁': 1}
        #print(self.p_class)  #{'文化': 84, '时尚': 82, ......}
        self.freq_to_prob()
        return 
    
    #将记录的词频和样本频率都转化为概率
    def freq_to_prob(self): #frequency to probability
        #样本概率的计算
        ...
        #print(self.word_class_prob) #'社会': {' 工地': 0.00026381743833267377, '女老板': 0.00026381743833267377,......}
        return 
    ...
    def classify(self, sentence):
        ...
        for class_name in self.p_class:
            prob = self.get_class_prob(words, class_name) #计算class_name类的概率
        ...
        results = [[c, prob/pw] for c, prob in results]  #归一化
